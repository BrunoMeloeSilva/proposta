package br.com.zupacademy.brunomeloesilva.share.meter;
...
public class MinhasMetricas {
	...
	public void meuContadorPropostasCriadas() {
		Collection<Tag> tags = new ArrayList<>();
		tags.add(Tag.of("emissora", "Mastercard"));
		tags.add(Tag.of("banco", "Itaú"));
	...
	public void meuTimerConsultarProposta(String idProposta) {
		Collection<Tag> tags = new ArrayList<>();
		tags.add(Tag.of("emissora", "Mastercard"));
		tags.add(Tag.of("banco", "Itaú"));
		...
		timerConsultarProposta.record(() -> {
			// Método da sua operação : Esse aqui não funfou ainda !
			// consultaProposta(idProposta);
		});
	}
